...
import { Archive, Box, Building2, CheckCircle2, ChevronDown, ChevronRight, MapPin, RefreshCw, Sparkles, Truck, Warehouse, X } from 'lucide-react';
                                                        ...
                                                        <div className="flex-1 p-3 overflow-y-auto max-h-[350px] custom-scrollbar space-y-2 relative">
                                                            {zone.items.length === 0 && (
                                                                <div className="absolute inset-0 flex flex-col items-center justify-center text-muted-foreground pointer-events-none">
                                                                    <Box className="w-10 h-10 opacity-20 mb-2" />
                                                                                            ...
                                                                                            >
                                                                                                <div className="w-6 h-6 bg-muted/50 rounded flex items-center justify-center overflow-hidden mb-1">
                                                                                                    {item.image ? (
                                                                                                        ...
                                                                                                        <Box className="w-3.5 h-3.5 text-muted-foreground/50" />
                                                                                                    )}
                                                                                                </div>
