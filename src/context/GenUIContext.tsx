...
export interface ArtifactData {
    id: string;
    type: 'order_correction' | 'stock_matrix' | 'layout_proposal' | 'warranty_claim' | 'quote_proposal' | 'field_mapping_request' | 'erp_connect_modal' | 'erp_po_dashboard' | 'asset_review' | 'mode_selection' | 'erp_selector' | 'text';
    title?: string;
    data?: any;
...
export const GenUIProvider = ({ children }: { children: ReactNode }) => {
    ...
    const sendMessage = async (content: string) => {
        ...
        setTimeout(() => {
            ...
            // Use Case: Mode Selection - ERP
                ...
                responseText = "Secure connection established with NetSuite. I found 3 actionable Purchase Orders.";
                responseArtifact = {
                    id: 'art_erp_select',
                    type: 'erp_selector',
                    title: 'ERP Integration: NetSuite',
                    data: {},
                    source: 'NetSuite connector'
                };
            }
    ...
    return (
        <GenUIContext.Provider value={{ messages, isGenerating, isStreamOpen, showTriggers, sendMessage, clearStream, toggleStream, setStreamOpen, setShowTriggers }}>
            {children}
